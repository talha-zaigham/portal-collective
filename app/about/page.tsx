        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12 sm:space-y-16">
              {/* The Concept */}
              <section>
                <h3 className="heading-md font-bold text-foreground mb-6 sm:mb-8">The Concept</h3>
                <div className="prose prose-lg prose-invert max-w-none">
                  <p className="body-md text-muted-foreground leading-relaxed mb-4 sm:mb-6">
              ...
              <section className="text-center">
                <h3 className="heading-md font-bold text-foreground mb-6 sm:mb-8">Join the Collective</h3>
                <p className="body-lg text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                  ...
                  <Link href="/gallery" className="btn-luxury-secondary btn-mobile">
                    View Artworks
                  </Link>
                </div>
              </section>
